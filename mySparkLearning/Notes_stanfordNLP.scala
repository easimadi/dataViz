// Databricks notebook source exported at Tue, 23 Feb 2016 20:50:42 UTC
...
val myval = scala.io.Source.fromFile("file:/mnt/xbrldata/sona/stop_words.txt").getLines().toSet

// COMMAND ----------

// MAGIC %fs mv("dbfs:/mnt/xbrldata/sona/stop_words.txt", "stop_words.txt" )
